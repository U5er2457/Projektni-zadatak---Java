...
/**
 * Unosi nove studenate u aplikaciju.
...
public class StudentInput {
    ...
    public StudentInput(List<Student> students) {
        this.students = students;
    }


    /**
     * Obrada unosa studenta iz konzole.
     * Metoda prikuplja sve potrebne podatke o studentu, validira podatke
     * pomoću {@link InputValidation}, omogućava odabir kolegija ovisno
     * o godini studija te kreira objekt {@link Student}.
     * @param sc Scanner korišten za čitanje korisničkog unosa
     */
