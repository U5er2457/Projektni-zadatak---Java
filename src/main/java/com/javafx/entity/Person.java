...
import com.javafx.entity.exception.EmptyFieldException;
import com.javafx.entity.interfaces.Contactable;
...
public abstract class Person implements Contactable, Serializable {
    ...
    /**
     * Radi novu osobu sa zadanim podacima.
     *
    ...
    protected Person(String firstName, String lastName, String email, String phoneNumber, String oib) {
    ...
    /**
     * Implementacija metode iz sučelja {@link Contactable} koja vraća e-mail adresu osobe.
     *
    ...
    /**
     * Implementacija metode iz sučelja {@link Contactable} koja vraća telefonski broj osobe.
     *
